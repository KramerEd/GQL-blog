...
const PostDetail = ({ post }) => {
  ...
  return (
    <div className="lg: mb-8 animate-appear rounded-lg bg-white p-8 pb-12 shadow-lg">
      ...
      <div className="px-4 lg:px-0">
        ...
        <h1 className="cursor-pointer pb-8  text-3xl font-semibold transition duration-500 ">
          {post.title}
        </h1>
